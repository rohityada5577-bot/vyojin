  ...
  public function up(): void
{
    Schema::table('orders', function (Blueprint $table) {
        ...
        $table->decimal('gst_amount', 10, 2)->default(0)->after('taxable_amount');
        ...
        $table->string('tax_type')->nullable()->after('igst_amount');
        $table->string('billing_state')->nullable()->after('tax_type');
    });
}
